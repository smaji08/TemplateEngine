//helper class for generating the team roster 
function generateHTML(empArray){
    var bhtml = `<!DOCTYPE html>
        ...
        <body>
            ...
            <div class="container container-main">
                <div class="grid-row">`
    //changing the fontawesome icons as per the roles
    ...
    //for outputting the role specific information
    ...
    //the card generation for each employee
                ...
                <div class="grid-item">
                    <div class="grid-item-content">
                        <div class="namedesig">
                            ...
                            <h4>${getIcons(emp)} ${emp.getRole()}</h4>
                        </div>
    ...
    //the magical part of template literals!!
